...
This module will create a new Virtual Network, associated subnets and network security groups in Azure. Module based on Azure-Terraform/terraform-azurerm-virtual-network
<br /><br />
