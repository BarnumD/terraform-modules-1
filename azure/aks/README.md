...
This repository contains opinionated Terraform that automates the deployment of an RBAC-enabled Azure Kubernetes Service cluster backed by Azure Active Directory. Code borrowed from [terraform-azurerm-kubernetes])https://github.com/Azure-Terraform/terraform-azurerm-kubernetes).
...
module "aks" {
  source = "git@github.com:Wycliffe-USA/terraform-modules.git//azure/aks?ref=v1.0.0"
...
module "aad-pod-identity" {
  source = "git@github.com:Wycliffe-USA/terraform-modules.git//azure/aks-aad-pod-identity?ref=v1.0.0"
